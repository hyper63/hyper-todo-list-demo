...
export const getTodos = (todos) => {
    return async (dispatch) => {
        try{
            let {data: allTodos} = await axios.get('/todos');
...
export const addTodo = (todo) => {
    return async (dispatch) => {
        try{
            let {data: newTodo} = await axios.post('/todos', todo)
...
export const updateTodo = (id) => {
    return async (dispatch) => {
        try{
            let {data: updated} = await axios.put(`/todos/${id}`)
...
export const deleteTodo = (id) => {
    return async (dispatch) => {
        try{
            let {data: deleted} = await axios.delete(`/todos/:${id}`)
